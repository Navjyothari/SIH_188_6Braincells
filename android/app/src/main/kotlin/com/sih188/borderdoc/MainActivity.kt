            ...
            .setMethodCallHandler { call, result ->
                when (call.method) {
                    ...
                    "verifyFace" -> {
                        ...
                        Thread {
                            try {
                                val liveBitmap = BitmapFactory.decodeFile(livePath)
                                val refBitmap  = if (refPath != null) {
                                    BitmapFactory.decodeFile(refPath)
                                } else {
                                    null  // module will use bundled synthetic reference
                                }
